...
const Card = ({ handleClick, title, imageSrc, buttonContent, id }) => {
  useEffect(() => {
    ...
    const elements = document.querySelectorAll(
      ".card-title, .card-button, .card-image"
    ); // Observe card titles, buttons, and images
    ...
    <section className="card-section" id={id}>
      <div className="card-background">
        <img
          src={imageSrc}
          alt="Card Background"
          className="card-image animated-image"
        />
